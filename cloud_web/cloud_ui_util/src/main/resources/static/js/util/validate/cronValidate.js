    ...
    (function (cloudo) {
        ...
        (function (quartz) {
            ...
            (function (ui) {
                var util;
                (function (util) {
                    var CronValidate = /** @class */ (function () {
                        function CronValidate() {
                        }
                        CronValidate.cronValidate = function (cronExpression) {
                            //返回错误信息用
                            var message = '';
                            //先将cron表达式进行分割
                    ...
                    util.CronValidate = CronValidate;
                })(util = ui.util || (ui.util = {}));
            })(ui = quartz.ui || (quartz.ui = {}));
        })(quartz = cloudo.quartz || (cloudo.quartz = {}));
