namespace com.clouddo.ui.util {
    ...
    export class Validate {
         ...
         * @returns {boolean}
         */
        public static validateLowerCase (value: any): boolean {
            const reg = /^[a-z]+$/
         ...
         * @returns {boolean}
         */
        public static validateUpperCase (value: any): boolean {
            const reg = /^[A-Z]+$/
            return reg.test(value)
        }
         ...
         * @returns {boolean} 验证结果
         */
        public static validateURL (url: any): boolean {
         ...
         * @returns {boolean}
         */
        public static validateMobile (mobile: any): {[index: string]: any} {
            let list = [];
            let result = true;
            let msg = '';
            ...
            let returnData: {[index: string]: any} = {}
         ...
         * @returns {boolean}
         */
        public static validatePositiveInteger (value: any): boolean {
            var re = /^[1-9]+[0-9]*]*$/
            if (re.test(value)) {
                return true
            }
         ...
         * @returns {boolean}
         */
        public static validateNumber (value: any): boolean {
            if(value === null || value === ''){
                return false;
            }
            if (!isNaN(value)) {
         ...
         */
        public static cardid (code: any): {[index: string]: any} {
            let list = [];
            let result = true;
            let msg = '';
            var city = {
         ...
         * @returns {any}
         */
        public static cronValidate (cronExpression: string): any {
            //返回错误信息用
            var message: any = '';
            //先将cron表达式进行分割
