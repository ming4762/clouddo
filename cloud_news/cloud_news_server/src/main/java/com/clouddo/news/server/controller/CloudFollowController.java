 ...
 */
@Controller
@RequestMapping(value = "/cloudFollow")
@Api(description = "跟帖信息控制类")
public class CloudFollowController extends AuthController<CloudFollow> {
	
	@Resource
	private CloudFollowService cloudFollowService;
     ...
     * @throws Exception
     */
   	@ApiOperation(value = "查询跟帖信息API", httpMethod = "POST", produces = MediaType.APPLICATION_JSON_UTF8_VALUE, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ApiImplicitParams({
...
//        Page page = PageHelper.startPage(parameterSet, CloudFollow.class);
//        List<CloudFollow> data = this.cloudFollowService.findAll(parameterSet);
...
//        returnData.put("total", page.getTotalPage());
    ...
    @ResponseBody
        public Object delete(@RequestBody List<CloudFollow> deleteObjects) {
        int deleteNum = this.cloudFollowService.delete(deleteObjects);
        return Result.success(deleteNum);
    }

    /**
     * 插入操作
     * @param  cloudFollow 要保存的实体
     * @return
     */
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "cloudFollow", value = "要插入数据库的实体类信息", required = true, dataType = "Object", paramType = "query"),
    			@ApiImplicitParam(name = "authority", value = "header里的认证串信息", required = true, dataType = "string", paramType = "header")
    })
    @RequestMapping("/insert")
    @ResponseBody
    public Object insert(@RequestBody CloudFollow cloudFollow) {
        Map<String, Object> saveMeg = this.cloudFollowService.saveOrUpdate(cloudFollow);
        return Result.success(saveMeg);
    }

    /**
     * 更新操作
     * @param  cloudFollow 要更新的实体类
     * @return 更新结果
     */
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "cloudFollow", value = "要更新到数据库的实体类信息", required = true, dataType = "Object", paramType = "query"),
    			@ApiImplicitParam(name = "authority", value = "header里的认证串信息", required = true, dataType = "string", paramType = "header")
    })
    @RequestMapping("/update")
    @ResponseBody
    public Object update(@RequestBody CloudFollow cloudFollow) {
        Map<String, Object> updateMeg = this.cloudFollowService.saveOrUpdate(cloudFollow);
        return Result.success(updateMeg);
    }

    /**
     * 查询单个结果
     * @param  cloudFollow 内含要获取实体的ID信息
     * @return 实体信息
     */
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "cloudFollow", value = "实体类（内含要获取实体类的主键信息）", required = true, dataType = "Object", paramType = "query"),
    			@ApiImplicitParam(name = "authority", value = "header里的认证串信息", required = true, dataType = "string", paramType = "header")
    })
    @RequestMapping("/get")
    @ResponseBody
    public Object get(@RequestBody CloudFollow cloudFollow) {
        return Result.success(this.cloudFollowService.get(cloudFollow));
    }

    /**
     * 更新/插入操作
     * @param  cloudFollow 要更新/插入的实体类
     * @return 结果
     */
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "cloudFollow", value = "要更新/插入到数据库的实体类信息", required = true, dataType = "Object", paramType = "query"),
    			@ApiImplicitParam(name = "authority", value = "header里的认证串信息", required = true, dataType = "string", paramType = "header")
    })
    @RequestMapping("/saveOrUpdate")
    @ResponseBody
    public Object saveOrUpdate(@RequestBody CloudFollow cloudFollow) {
        return Result.success(this.cloudFollowService.saveOrUpdate(cloudFollow));
    }
